...
export const metadata: Metadata = {
  title: "ENT Practice Management Software — Netcare Health OS | South Africa",
  ...
  openGraph: {
    title: "ENT Practice Management Software — Netcare Health OS",
    ...
    type: "website",
    locale: "en_ZA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Netcare Health OS — ENT Practice Management" }],
  },
};
