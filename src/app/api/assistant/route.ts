...
const ACTION_PATTERNS: Array<{ patterns: RegExp[]; action: UIAction }> = [
  ...
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(copilot|claims.?chat)/i, /(pull up|show|open|take me|go to|navigate|bring up).*(copilot)/i, /ask.*about.*(icd|code|claim)/i], action: { type: "navigate", target: "/dashboard/claims-copilot", label: "Claims Copilot" } },
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(bridge|careon|hl7|fhir)/i, /(pull up|show|open|take me|go to|navigate|bring up).*(bridge|careon)/i], action: { type: "navigate", target: "/dashboard/bridge", label: "CareOn Bridge" } },
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(switch|edifact|routing)/i, /(pull up|show|open|take me|go to|navigate|bring up).*(switch)/i], action: { type: "navigate", target: "/dashboard/switching", label: "Switching Engine" } },
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(patient|patient.?list)/i, /(pull up|show|open|take me|go to|navigate|bring up).*(patient)/i, /find.*patient/i], action: { type: "navigate", target: "/dashboard/patients", label: "Patient Records" } },
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(booking|calendar|schedule)/i, /(pull up|show|open|take me|go to|navigate|bring up).*(booking|calendar)/i], action: { type: "navigate", target: "/dashboard/bookings", label: "Bookings" } },
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(checkin|check.?in|queue|waiting)/i, /(pull up|show|open|take me|go to|navigate|bring up).*(queue|waiting)/i, /who.?s next/i], action: { type: "navigate", target: "/dashboard/checkin", label: "Check-in Queue" } },
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(billing|invoice)/i, /(pull up|show|open|take me|go to|navigate|bring up).*(invoice|billing)/i], action: { type: "navigate", target: "/dashboard/billing", label: "Billing & Invoicing" } },
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(recall|follow.?up|remind)/i, /(pull up|show|open|take me|go to|navigate|bring up).*(recall|overdue)/i], action: { type: "navigate", target: "/dashboard/recall", label: "Patient Recall" } },
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(daily|task|checklist|morning)/i, /(pull up|show|open|take me|go to|navigate|bring up).*(daily|task)/i], action: { type: "navigate", target: "/dashboard/daily", label: "Daily Tasks" } },
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(document|referral|prescription|sick.?note)/i, /generate.*(document|letter|prescription)/i], action: { type: "navigate", target: "/dashboard/documents", label: "Document Generator" } },
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(notification|alert)/i, /(pull up|show|open|take me|go to|navigate|bring up).*(notification)/i], action: { type: "navigate", target: "/dashboard/notifications", label: "Notifications" } },
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(referral)/i, /(pull up|show|open|take me|go to|navigate|bring up).*(referral)/i], action: { type: "navigate", target: "/dashboard/referrals", label: "Referrals" } },
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(network|clinic|medicross)/i, /(pull up|show|open|take me|go to|navigate|bring up).*(network|all.?clinic)/i], action: { type: "navigate", target: "/dashboard/network", label: "Network Command" } },
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(executive|sara|revenue|recovery)/i, /(pull up|show|open|take me|go to|navigate|bring up).*(executive|dashboard)/i], action: { type: "navigate", target: "/dashboard/executive", label: "Executive Dashboard" } },
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(architecture|tech.?stack|api)/i, /(pull up|show|open|take me|go to|navigate|bring up).*(architecture|tech)/i], action: { type: "navigate", target: "/dashboard/architecture", label: "Architecture" } },
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(governance|compliance|certif|king.?v|popia|sahpra)/i, /(pull up|show|open|take me|go to|navigate|bring up).*(governance|compliance)/i], action: { type: "navigate", target: "/dashboard/ai-governance", label: "AI Governance" } },
  ...
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(assistant|help|agent)/i], action: { type: "navigate", target: "/dashboard/assistant", label: "AI Assistant" } },
  ...
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(chain|13.?step|full.?flow)/i, /how.*claim.*flow/i], action: { type: "navigate", target: "/dashboard/integration-map", label: "13-Step Claims Chain" } },
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(agent|all.?agent)/i], action: { type: "navigate", target: "/dashboard/integration-map", label: "AI Agents" } },
  { patterns: [/(pull up|show|open|take me|go to|navigate|bring up).*(benchmark|result|accuracy|test)/i], action: { type: "navigate", target: "/dashboard/resources", label: "Benchmarks & Results" } },
];
