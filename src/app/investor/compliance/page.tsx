...
const regulations = [
  {
    ...
    color: "#10b981",
    requirements: [
      { item: "Explicit consent for health data processing", status: "compliant", products: ["Netcare Health OS"] },
      { item: "Separate marketing consent (not bundled)", status: "compliant", products: ["Netcare Health OS"] },
      { item: "POPIA consent records with audit trail", status: "compliant", products: ["Netcare Health OS"] },
      { item: "Right to withdraw consent", status: "compliant", products: ["Netcare Health OS"] },
      { item: "Information Officer designation (POPIA s55)", status: "compliant", products: ["Netcare Health OS"] },
      { item: "Cross-border data transfer compliance", status: "compliant", products: ["Netcare Health OS", "Visio Health Integrator"] },
      { item: "Data retention policy enforcement", status: "compliant", products: ["Netcare Health OS"] },
      { item: "Breach notification procedures (POPIA s22)", status: "compliant", products: ["Netcare Health OS"] },
      { item: "Privacy Policy page (POPIA-compliant, public)", status: "compliant", products: ["Netcare Health OS"] },
      { item: "Data subject request form (s23-25)", status: "compliant", products: ["Netcare Health OS"] },
      { item: "Cookie Policy page", status: "compliant", products: ["Netcare Health OS"] },
      { item: "PAIA s51 Manual", status: "compliant", products: ["Netcare Health OS"] },
      { item: "Data Processing Agreement template", status: "compliant", products: ["Netcare Health OS"] },
    ],
  },
  {
    name: "HPCSA",
    ...
    color: "#8B5CF6",
    requirements: [
      { item: "Practitioner verification before onboarding", status: "planned", products: ["Netcare Health OS", "Placeo Health"] },
      { item: "No canvassing/touting in platform marketing", status: "compliant", products: ["Placeo Health"] },
      { item: "Patient record retention (6yr+ from dormancy)", status: "compliant", products: ["Netcare Health OS"] },
      { item: "Audit logging for all patient data access", status: "compliant", products: ["Netcare Health OS"] },
      { item: "Role-based access control", status: "compliant", products: ["Netcare Health OS"] },
      ...
      { item: "AI clinical disclaimer component", status: "compliant", products: ["Netcare Health OS", "VisioMed AI"] },
      { item: "Scope of practice enforcement", status: "planned", products: ["Netcare Health OS", "VisioMed AI"] },
    ],
  },
  {
    name: "ICD-10 SA",
    ...
    color: "#3B82F6",
    requirements: [
      { item: "ICD-10 codes in invoice line items", status: "compliant", products: ["Netcare Health OS"] },
      { item: "SA Master Industry Table codes only", status: "planned", products: ["Netcare Health OS", "Netcare Health OS Payer Connect"] },
      { item: "Highest specificity enforcement", status: "planned", products: ["Netcare Health OS"] },
      { item: "External Cause Code pairing for T-codes", status: "planned", products: ["Netcare Health OS", "Netcare Health OS Payer Connect"] },
  ...
  },
  {
    ...
    color: "#f59e0b",
    requirements: [
      { item: "Transparent fee disclosure (Booklet 19)", status: "compliant", products: ["Netcare Health OS"] },
      { item: "Direct marketing time restrictions", status: "planned", products: ["Netcare Health OS"] },
      { item: "Opt-out mechanism in all communications", status: "compliant", products: ["Netcare Health OS"] },
      { item: "Plain language in patient communications", status: "compliant", products: ["Netcare Health OS"] },
  ...
  },
  {
    ...
    requirements: [
      ...
      { item: "No false coverage guarantees in marketing", status: "compliant", products: ["Netcare Health OS"] },
      { item: "Medical aid claim status transparency", status: "compliant", products: ["Netcare Health OS"] },
    ],
  },
  {
    name: "Medicines Act",
  ...
  },
  {
    ...
    color: "#0ea5e9",
    requirements: [
      { item: "Business details on website (name, address, registration)", status: "compliant", products: ["Netcare Health OS"] },
      { item: "Electronic consent legally valid", status: "compliant", products: ["Netcare Health OS", "Visio Waiting Room"] },
      { item: "SSL/TLS encryption on all data transmission", status: "compliant", products: ["Netcare Health OS"] },
      { item: "Terms & conditions accessible (/terms)", status: "compliant", products: ["Netcare Health OS"] },
      { item: "ECTA s43 company info in footer", status: "compliant", products: ["Netcare Health OS"] },
    ],
  },
];

const productIcons: Record<string, React.ElementType> = {
  "Netcare Health OS": HeartPulse,
