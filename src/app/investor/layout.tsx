...
export const metadata: Metadata = {
  title: "Investor Portal — Health OS Ecosystem",
  description: "Health OS investor portal. 6 healthcare products, one ecosystem. AI-powered practice management by Visio Research Labs.",
    ...
    <div className="flex h-screen bg-[var(--obsidian)]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="h-14 shrink-0 border-b border-gray-200 bg-white flex items-center justify-between px-6">
          <span className="text-[13px] text-gray-500 font-medium">Health OS Ecosystem — Investor Portal</span>
