      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="space-y-8">
          ...
          <section>
              ...
              <table className="w-full text-left text-sm">
                <thead>
                  <tr className="border-b border-white/[0.06]">
                    <th className="py-2 pr-4 text-xs text-white/60 font-mono font-normal">Cookie</th>
                    <th className="py-2 pr-4 text-xs text-white/60 font-mono font-normal">Purpose</th>
                    <th className="py-2 text-xs text-white/60 font-mono font-normal">Duration</th>
                  </tr>
                </thead>
            ...
            <p className="text-sm text-white/70 leading-relaxed font-light mt-4">
