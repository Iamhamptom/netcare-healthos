        ...
        {sent ? (
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="forgot-email" className="block text-[12px] font-semibold text-gray-600 mb-1">Email address</label>
              ...
              {error && <p role="alert" id="forgot-error" className="text-[12px] text-red-500">{error}</p>}
              <button type="submit" disabled={loading}
                ...
                {loading ? <Loader2 className="w-4 h-4 animate-spin" role="status" aria-label="Sending" /> : null}
