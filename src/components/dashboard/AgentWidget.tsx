...
export default function AgentWidget() {
  ...
  const send = useCallback(async () => {
    ...
    const FAST_ANSWERS: Record<string, string> = {
      ...
      "analyse": "Yes! I can analyse documents, claims, and clinical data. Try:\n\n- **Upload a CSV** of claims for batch validation\n- **Paste clinical notes** for ICD-10 coding\n- **Ask about any code** (ICD-10, NAPPI, tariff)\n\nSay **'take me to claims'** to upload a file, or **'take me to AI coder'** to paste notes.",
      "document": "I can generate documents instantly:\n\n- **Referral letters** — to specialists\n- **Prescriptions** — with NAPPI codes\n- **Sick notes** — medical certificates\n- **SARAA motivations** — for biologics\n\nSay **'take me to documents'** to start, or tell me what you need and I'll generate it.",
